...
## 2. repository variable에 BAEKJOON_ID 등록하기, 공용 레포의 본인 디렉토리 명과 통일하면 됨!
> action을 돌려서 본인 폴더에 자동으로 백준 문제를 저장하기 위함입니다.. 반드시 해야돼요❗️

### 2- 1. fork 한 레포의 세팅으로 들어가기 
<img width="657" height="484" alt="image" src="https://github.com/user-attachments/assets/d0d44a28-e661-4414-bd17-0d5ed0c6ca6a" />

### 2- 2. 좌측 목록의 secutiry >> sercets and variables > actions 들어가기 
...
---
## 3. 백준 문제 풀고 본인 레포에서 move 라는 이름의 action이 잘 실행되는지 확인하기
